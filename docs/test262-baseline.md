...
- `language max-cases=5000`: discovered=23882, executed=1837, skipped=22045, passed=1100, failed=737
...
- 当前仍处于语法/运行时早期阶段，失败主要来自语义不完整与内建缺失（如数组字面量、ASI、`this`、严格模式、内建对象与 harness）。
