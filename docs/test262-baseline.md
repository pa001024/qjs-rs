...
- `language max-cases=5000`: discovered=23882, executed=5000, skipped=18579, passed=3626, failed=1374
...
- 在当前 `language max-cases=5000` 口径下，执行规模提升至 `5000`，当前通过/失败为 `3626/1374`（主要剩余在块级作用域细节、`super` 语义、strict/directive-prologue 早期错误与部分内建缺失）。
