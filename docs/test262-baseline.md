...
- `built-ins/Map --max-cases 200 (v1-s200)`: discovered=204, executed=53, skipped=151, passed=49, failed=4
...
- `language max-cases=5000 (latest+42)`: discovered=23882, executed=5000, skipped=18579, passed=4862, failed=138
- `language max-cases=5000 (latest+43)`: discovered=23882, executed=5000, skipped=18579, passed=4863, failed=137
- `language max-cases=5000 (latest+44)`: discovered=23882, executed=5000, skipped=18579, passed=4868, failed=132
...
- `built-ins/Object (v96)`: discovered=3411, executed=2255, skipped=1156, passed=2255, failed=0
- `built-ins/Array --max-cases 100 (v4-s100)`: discovered=3081, executed=100, skipped=133, passed=100, failed=0
- `built-ins/Array/length (v5-full)`: discovered=30, executed=26, skipped=4, passed=26, failed=0
- `built-ins/Array/of (v1)`: discovered=16, executed=9, skipped=7, passed=9, failed=0
- `built-ins/Array --max-cases 300 (v6-s300)`: discovered=3081, executed=300, skipped=261, passed=150, failed=150
- `built-ins/Array/prototype/concat (v2)`: discovered=69, executed=14, skipped=55, passed=14, failed=0
...
- `built-ins/Array/prototype/pop (v20)`: discovered=23, executed=17, skipped=6, passed=17, failed=0
- `built-ins/Array/prototype/push (v20)`: discovered=24, executed=17, skipped=7, passed=17, failed=0
- `built-ins/Array/prototype/reduce (v20)`: discovered=260, executed=252, skipped=8, passed=252, failed=0
- `built-ins/Array/prototype/reduceRight (v21)`: discovered=260, executed=251, skipped=9, passed=251, failed=0
- `built-ins/Array/prototype/reverse (v23)`: discovered=18, executed=11, skipped=7, passed=11, failed=0
- `built-ins/Array/prototype/shift (v23)`: discovered=20, executed=16, skipped=4, passed=16, failed=0
...
- `language/statements/let (latest)`: discovered=145, executed=43, skipped=102, passed=43, failed=0
...
- VM 增加 `execute_construct_value` 并修正 `BoundCall` 构造语义：`new (Ctor.bind(thisArg, ...boundArgs))(...args)` 走构造目标函数路径（忽略绑定 this，保留绑定参数前置），收敛 `class/subclass/binding.js` 与 `default-constructor-2.js`。该轮后 `language/statements/class` 提升至 `168/20`，整体 `language` 基线提升至 `4862/138`（快照：`target/test262-language-baseline-5000-20260224-v23.json`）。
- VM 对 derived constructor 返回 object-like 的分支放宽为“可绕过 `this` 初始化检查”，与规范 `return object` override 对齐，修复 `class-definition-null-proto-contains-return-override.js`。该轮后 `language/statements/class` 提升至 `169/19`，整体 `language` 基线提升至 `4863/137`（快照：`target/test262-language-baseline-5000-20260224-v24.json`）。
- VM 对齐 QuickJS `set_array_length` 核心行为：数组/数组子类实例在写入更小 `length` 时删除尾部 index 属性；同时补齐 `Number.prototype.toExponential` 与 `String.prototype.trim` 最小语义。parser/bytecode 另行拆分派生构造器 `super()` 与 `super.prop` 基对象（`super` ctor vs `super.prototype`），修复 `class/super/in-constructor`。该轮后 `language/statements/class` 提升至 `173/15`、`language/statements/class/super`=`8/0`，整体 `language` 基线提升至 `4868/132`（快照：`target/test262-language-baseline-5000-20260224-v25.json`）。
...
- 对齐 QuickJS `js_obj_to_desc` 与函数对象原型链行为：`Object.defineProperty` 接入运行时 `ToPropertyKey`，并让 `Function/HostFunction` 读写与 `for-in` 走原型链语义（含 `Function.prototype` 上数据/访问器属性继承）；同时修复 generic descriptor 更新错误清空 accessor 的回归。`Object.defineProperty` 收敛至 `722/0`，`built-ins/Object` 继续提升至 `2056/199`（快照：`target/test262-builtins-object-20260224-v77.json`）。
