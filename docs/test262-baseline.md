...
- `language max-cases=5000`: discovered=23882, executed=5000, skipped=18579, passed=3661, failed=1339
...
- 在当前 `language max-cases=5000` 口径下，执行规模提升至 `5000`，当前通过/失败为 `3661/1339`（主要剩余在块级作用域细节、`super` 语义、`for-in` 迭代语义与部分内建缺失）。
