...
- `test262 built-ins/Array --max-cases 2000` 最新采样：`executed=2000`、`passed=1937`、`failed=63`（快照：`target/test262-builtins-array-20260225-v21-s2000.json`；阶段性对比：`v13-s2000=1373/627`、`v16-s2000=1547/453`、`v20-s2000=1718/282`）。
- 本轮新增语义收敛：
